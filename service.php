...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(img/background1.jpg);">
    ...
    <div class="container-xxl service py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Explore  Tv Our Services</h1>
            </div>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-6 py-5">
                    <div class="py-5">
                        <h1 class="text-white mb-4">Certified and Award Winning TV Repair Service Provider</h1>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-sm-6">
                                    <select class="form-select border-0" onclick="clearservicevalidation()" id="service" required name="service" style="height: 55px;">
                                        ...
                                        <option value="LED Tv Service">LED Tv Service</option>
                                        <option value="LCD TV Service">LCD TV Service</option>
                                        <option value="CRT Tv Service">CRT Tv Service</option>
                                        <option value="Backlight of the TV">Backlight of the TV</option>
